...
| [现状分析](./2026-08-27-analysis.md) | 性能 / 完整度 / UX 审计原文（含 1–8 证据与剩余项→Task 映射） | 需要理解「为什么改」时先读；**不要按本文实现** |
| [代码库地图](./2026-08-27-followup-codebase-map.md) | 加命令 / Driver / Webview / MCP 的 cookbook + `src/` 文件索引 | 找不到某段代码、或要新增一类能力时 |
